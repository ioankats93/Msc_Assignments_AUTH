...
<style>
  ...
  #section2 {padding-top:50px;height:auto;color: #000; background-color: #fff;}
  #section3 {padding-top:50px;height:auto;color: #000; background-color: #fff;}
...
<div class="container-fluid" style="background-color:#d1e3ea; color:#330033; height:140px;">
        <div class="row">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Προβολή <span class="caret"></span></a>
        <ul class="dropdown-menu">
          ...
          <li><a href="#section2">Τοποθεσίες που Καταχωρήθηκαν</a></li>
          <li><a href="#section3">Τοποθεσίες που Επισκευάστηκαν</a></li>
        </ul>
      </li>
      <?php
            if (isset($_SESSION['userName'])){
              echo '
              <li><a href="dm1002Administrator.php"> Διαχείριση</a></li>';          			
            }
            else
    				{
    				  echo '';
...
<div id="section2" class="container-fluid">
  <h1>Πίνακας Τοποθεσιών που Καταχωρήθηκαν</h1>
          ...
          <table class="table table-striped">
            <thead>
              <tr>
                ...
                <th class="text-center">Ημερομηνία Καταχώρησης</th>
...
<div id="section3" class="container-fluid">
  <h1>Πίνακας Τοποθεσιών που Επισκευάστηκαν</h1>
  <div class="col-sm-12 text-center"> 
        <div id="centerContainer">              
          <table class="table table-striped table-fixed">
            <thead>
              <tr>
                <th class="text-center">Α/Α</th>
                <th class="text-center">Ημερομηνία Επισκευής</th>
                <th class="text-center">Χρήστης</th>
                <th class="text-center">Διεύθυνση</th>
                <th class="text-center">Τύπος</th>
              </tr>
                  ...
                  while($row = mysqli_fetch_array($result)){
                    if($row['repaired']=="ΝΑΙ"){
                      echo '<tr data-item="action1">
                          ...
                          <td class="text-Left"> '. $row['repairedDate'] .' </td>
                          <td class="text-Left"> '. $row['name'] .' </td>
                          <td class="text-Left"> '. $row['address'] .' </td>
                          <td class="text-Left"> '. $row['type'] .' </td>
